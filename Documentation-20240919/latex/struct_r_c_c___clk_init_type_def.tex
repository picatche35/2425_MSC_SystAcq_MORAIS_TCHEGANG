\doxysection{Référence de la structure RCC\+\_\+\+Clk\+Init\+Type\+Def}
...
The AHB clock (HCLK) divider. This clock is derived from the system clock (SYSCLK). This parameter can be a value of \doxylink{group___r_c_c___a_h_b___clock___source}{AHB Clock Source} ~\newline
...
The clock to be configured. This parameter can be a value of \doxylink{group___r_c_c___system___clock___type}{System Clock Type} ~\newline
...
The clock source used as system clock (SYSCLK). This parameter can be a value of \doxylink{group___r_c_c___system___clock___source}{System Clock Source} ~\newline
