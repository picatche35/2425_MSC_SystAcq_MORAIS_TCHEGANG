\doxysection{Référence de la structure UART\+\_\+\+Init\+Type\+Def}
...
This member configures the UART communication baud rate. The baud rate register is computed using the following formula\+: \hypertarget{struct_u_a_r_t___init_type_def_autotoc_md13}{}\doxysubsection{\texorpdfstring{LPUART\+:}{LPUART\+:}}\label{struct_u_a_r_t___init_type_def_autotoc_md13}
Baud Rate Register = ((256 \texorpdfstring{$\ast$}{*} lpuart\+\_\+ker\+\_\+ckpres) / ((huart-\/\texorpdfstring{$>$}{>}Init.\+Baud\+Rate))) where lpuart\+\_\+ker\+\_\+ck\+\_\+pres is the UART input clock divided by a prescaler \hypertarget{struct_u_a_r_t___init_type_def_autotoc_md14}{}\doxysubsection{\texorpdfstring{UART\+:}{UART\+:}}\label{struct_u_a_r_t___init_type_def_autotoc_md14}
